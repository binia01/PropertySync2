...
abstract class $PropertyResponseCopyWith<$Res> {
  factory $PropertyResponseCopyWith(
    ...
    $Res Function(PropertyResponse) then,
...
abstract class _$$PropertyResponseImplCopyWith<$Res>
    implements $PropertyResponseCopyWith<$Res> {
  factory _$$PropertyResponseImplCopyWith(
    _$PropertyResponseImpl value,
...
class __$$PropertyResponseImplCopyWithImpl<$Res>
  ...
  __$$PropertyResponseImplCopyWithImpl(
    _$PropertyResponseImpl _value,
...
class _$PropertyResponseImpl implements _PropertyResponse {
  const _$PropertyResponseImpl({
    ...
    @JsonKey(name: "beds") this.beds,
    @JsonKey(name: "baths") this.baths,
  ...
  @override
  String toString() {
    return 'PropertyResponse(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, title: $title, description: $description, price: $price, location: $location, beds: $beds, baths: $baths, area: $area, status: $status, sellerId: $sellerId)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PropertyResponseImplToJson(this);
  }
}
...
abstract class _PropertyResponse implements PropertyResponse {
  const factory _PropertyResponse({
    ...
    @JsonKey(name: "beds") final int? beds,
    @JsonKey(name: "baths") final int? baths,
